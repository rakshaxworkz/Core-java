class DebitCardRunner{
    ...
    public static void main(String debit[]){
		...
		card.cardId = 680909;
		card.cardHolderName = "Raksha Shetty";
		card.cardNo = 8776643345678L;
		...
		card5.cardId = 76785;
		card5.cardHolderName = "Sudarshan";
